...
export const ContextMenuCheckboxItem = <T extends ValidComponent = "div">(
  ...
  return (
    <ContextMenuPrimitive.CheckboxItem
      ...
      {...rest}
    >
      <ContextMenuPrimitive.ItemIndicator class="absolute left-2 inline-flex h-4 w-4 items-center justify-center">
...
export const ContextMenuRadioItem = <T extends ValidComponent = "div">(
  ...
  return (
    <ContextMenuPrimitive.RadioItem
      ...
      {...rest}
    >
      <ContextMenuPrimitive.ItemIndicator class="absolute left-2 flex h-4 w-4 items-center justify-center">
