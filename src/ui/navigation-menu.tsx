...
type withArrow = { withArrow?: boolean };
    ...
    return (
        ...
        >
            ...
            <NavigationMenuPrimitive.Viewport
                class={cn(
                    "pointer-events-none z-50 overflow-x-clip overflow-y-visible rounded-md",
...
export const NavigationMenuTrigger = <T extends ValidComponent = "button">(
    ...
    return (
        <NavigationMenuPrimitive.Trigger
            class={cn(
                "inline-flex w-max items-center justify-center rounded-md px-4 py-2",
                "text-sm font-medium",
