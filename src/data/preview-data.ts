    ...
    days: [
        {
            ...
            items: [
                {
                    time: "09:00",
                    item: { name: "Meiji Shrine", category: "Attraction", description: "Peaceful forest shrine.", latitude: 35.6764, longitude: 139.6993 }
                },
                {
                    time: "11:30",
                    item: { name: "Harajuku Takeshita Street", category: "Shopping", description: "Kawaii culture epicenter.", latitude: 35.6715, longitude: 139.7030 }
                },
                {
                    time: "13:00",
                    item: { name: "Afuri Ramen", category: "Restaurant", description: "Famous yuzu shio ramen.", latitude: 35.6710, longitude: 139.7025 }
                },
                {
                    time: "15:00",
                    item: { name: "Shibuya Crossing", category: "Attraction", description: "The world's busiest crossing.", latitude: 35.6595, longitude: 139.7004 }
                },
            ]
        },
        {
            ...
            items: [
                {
                    time: "10:00",
                    item: { name: "TeamLab Planets", category: "Activity", description: "Immersive digital art museum.", latitude: 35.6530, longitude: 139.7972 }
                },
                {
                    time: "13:30",
                    item: { name: "Tsukiji Outer Market", category: "Food", description: "Fresh seafood and street snacks.", latitude: 35.6655, longitude: 139.7707 }
                },
                {
                    time: "16:00",
                    item: { name: "Akihabara Electric Town", category: "Shopping", description: "Anime, manga, and electronics.", latitude: 35.6984, longitude: 139.7730 }
                }
            ]
        }
    ],
