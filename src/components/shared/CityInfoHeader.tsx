    ...
    <div class="relative overflow-hidden rounded-3xl bg-white dark:bg-gray-800 p-8 shadow-sm ring-1 ring-gray-100 dark:ring-gray-700 mb-6">
      ...
      <div class="relative z-10">
        <div class="flex flex-col gap-4">
          ...
          <Show
            when={!props.loading}
            fallback={<div class="h-10 w-48 bg-gray-200 dark:bg-gray-700 rounded animate-pulse" />}
          >
          ...
          <Show
            when={!props.loading}
            fallback={
              <div class="h-20 w-full bg-gray-200 dark:bg-gray-700 rounded animate-pulse" />
            }
          >
