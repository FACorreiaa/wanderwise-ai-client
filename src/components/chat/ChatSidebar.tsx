        ...
        <div class="p-3 sm:p-4 border-b border-gray-200/50 dark:border-white/10">
          <div class="flex items-center justify-between mb-3 sm:mb-4">
            ...
            <div class="flex items-center gap-1">
              ...
              <button
                onClick={props.onClose}
                class="p-2 text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg lg:hidden"
                title="Close"
              >
                <X class="w-4 h-4" />
              </button>
                ...
                <For each={props.profiles}>
                  {(profile) => (
                    <button
                      ...
                      class={`w-full flex items-center gap-2 sm:gap-3 p-2 sm:p-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors first:rounded-t-xl last:rounded-b-xl ${
