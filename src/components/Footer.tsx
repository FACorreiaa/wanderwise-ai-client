...
export default function Footer() {
  return (
    <footer class="relative isolate overflow-hidden bg-slate-950 text-white border-t border-white/10">
      ...
      />
      <div
        class="absolute inset-0 bg-[linear-gradient(to_right,rgba(255,255,255,0.05)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.05)_1px,transparent_1px)] bg-[size:120px_120px] opacity-30 [mask-image:radial-gradient(circle_at_center,rgba(0,0,0,0.75),transparent_65%)]"
        aria-hidden="true"
      />
      <div
        class="absolute inset-x-0 top-1/3 h-px bg-gradient-to-r from-transparent via-cyan-400/50 to-transparent opacity-70"
        aria-hidden="true"
      />
      ...
      <div class="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-10">
          ...
          <div class="grid grid-cols-2 gap-8 sm:grid-cols-3 lg:grid-cols-4">
            <div class="space-y-3">
              ...
              <ul class="space-y-2 text-sm text-slate-100">
                <li>
                  <a
                    class="transition-colors duration-200 hover:text-cyan-300 hover:underline focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-slate-950 rounded"
                    href="#"
                  >
                    Platform
                  </a>
        ...
        <div class="flex flex-col gap-3 border-t border-white/10 pt-6 text-sm sm:flex-row sm:items-center sm:justify-between">
          ...
          <div class="flex flex-wrap gap-4 text-slate-100">
            <a
              class="hover:text-cyan-300 hover:underline transition-colors focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-slate-950 rounded"
              href="#"
            >
              Privacy
            </a>
