            ...
            <div class="mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8">
                    ...
                    <div class="sm:col-span-2 lg:col-span-1">
                        ...
                        <p class="text-gray-400 text-sm text-center sm:text-left max-w-xs mx-auto sm:mx-0">
                    ...
                    <div class="text-center sm:text-left">
                        ...
                        <ul class="space-y-2 text-sm text-gray-400">
                            <li><a href="#" class="hover:text-white transition-colors duration-200">Platform</a></li>
                            <li><a href="#" class="hover:text-white transition-colors duration-200">Enterprise</a></li>
                    ...
                    <div class="text-center sm:text-left">
                        ...
                        <ul class="space-y-2 text-sm text-gray-400">
                            ...
                            <li><a href="#" class="hover:text-white transition-colors duration-200">Reports</a></li>
                ...
                <div class="border-t border-gray-800 mt-6 sm:mt-8 pt-6 sm:pt-8 text-center text-sm text-gray-400">
