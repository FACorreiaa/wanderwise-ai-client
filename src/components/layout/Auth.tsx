...
const AuthLayout: Component<{ children: any; showBackButton?: boolean; onBack?: () => void }> = (props) => {
    return (
        <div class="min-h-screen bg-gradient-to-b from-blue-50 via-purple-50 to-white flex items-center justify-center p-3 sm:p-4 md:p-6">
            <div class="w-full max-w-sm sm:max-w-md">
                <Show when={props.showBackButton}>
                    <button
                        onClick={props.onBack}
                        class="flex items-center gap-2 mb-4 sm:mb-6 text-gray-600 hover:text-gray-900 transition-colors"
                    >
                ...
                <div class="bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-xl border border-white/20 p-4 sm:p-6 md:p-8">
                    {props.children}
                </div>

                {/* Footer - Mobile optimized text */}
                <div class="text-center mt-4 sm:mt-6 text-xs sm:text-sm text-gray-500 px-2 sm:px-0">
