...
import { FiArrowRight, FiCheck, FiMapPin, FiHeart, FiMessageCircle, FiUser, FiList, FiCamera } from 'solid-icons/fi';
                  ...
                  <div class="flex-1">
                    <div class="flex items-center gap-2">
                      <h5 class={`text-sm font-medium ${
                        step.completed ? 'text-green-900 dark:text-green-100' : 'text-gray-900 dark:text-white'
                      }`}>
                        {step.title}
                      </h5>
                      {step.completed && (
                    ...
                    <p class={`text-xs ${
                      step.completed ? 'text-green-700 dark:text-green-300' : 'text-gray-600 dark:text-gray-300'
                    }`}>
                      {step.description}
                    </p>
                  </div>
