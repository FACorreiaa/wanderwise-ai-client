      ...
      <div class="bg-white/90 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div class="space-y-1">
                  <input
                    ...
                    class={`w-full px-3 py-2.5 border rounded-xl focus:ring-2 focus:border-transparent text-sm bg-white dark:bg-gray-800 transition-colors ${
                      newTagErrors().name
                      ...
                      <div class="flex items-start justify-between gap-3">
                        ...
                        <div class="flex flex-col items-end gap-2">
                          <Show when={tag.source === "global"}>
                            <span class="px-2 py-1 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-200 rounded-full text-xs font-semibold border border-blue-100 dark:border-blue-800">
                              Global
                            </span>
                          </Show>
                          <span
        ...
        <Show when={props.tags.length > 0}>
          <div class="mt-8 pt-6 border-t border-gray-200">
            <h4 class="font-semibold text-gray-900 mb-4">Active Tags ({activeTags().length})</h4>
