    ...
    return (
        <AuthLayout>
            <div class="text-center mb-6">
                ...
                <p class="text-gray-600">Start discovering personalized travel experiences</p>
            </div>
            ...
            <form onSubmit={handleSubmit} class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        >
                            {showPassword() ? <VsEyeClosed class="w-5 h-5" /> : <VsEye class="w-5 h-5" />}
                        </button>
                    </div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <Button variant="outline" class="py-3 border-gray-200 hover:bg-gray-50">
