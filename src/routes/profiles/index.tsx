import { Copy, Edit, Plus, Trash2, User, X } from "lucide-solid";
...
export default function ProfilesPage() {
  ...
  const budgetOptions = [
    {
      ...
      description: "Free and low-cost activities",
    },
    {
      id: "medium",
      label: "Moderate Spending",
      description: "Mix of free and paid experiences",
    },
    {
      id: "high",
      label: "Premium Experience",
      description: "High-end activities and dining",
    },
  ];
  ...
  const travelStyleOptions = [
    ...
    },
    {
      id: "culinary",
      label: "Culinary",
      description: "Food, restaurants, markets",
    },
    {
      id: "adventure",
      label: "Adventure",
        ...
        <div class="space-y-3 mb-4">
          <div class="flex items-center gap-2 text-sm">
            ...
            <span class="font-medium text-gray-700">
              {
                travelStyleOptions.find((s) => s.id === profile.travelStyle)
                  ?.label
              }
            </span>
            ...
            {(budget) => (
              <label class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                <input
                  ...
                  onChange={() =>
                    setProfileForm((prev) => ({ ...prev, budget: budget.id }))
                  }
            ...
            {(group) => (
              <label class="relative cursor-pointer">
                <input
                  ...
                  onChange={() =>
                    setProfileForm((prev) => ({ ...prev, groupSize: group.id }))
                  }
                  class="sr-only"
                />
                <div
          ...
          <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p class="text-gray-600 mt-1">
                Manage your personalized travel preferences
              </p>
            </div>
            <button
          ...
          fallback={
            <div class="text-center py-12">
              ...
              <p class="text-gray-600 mb-4">
                Create your first travel profile to get personalized
                recommendations
              </p>
              <button
                onClick={() => setShowCreateModal(true)}
