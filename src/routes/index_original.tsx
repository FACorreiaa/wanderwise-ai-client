...
import { Loader2, MapPin, Send } from "lucide-solid";
...
const LandingPage: Component = () => {
  ...
  const [streamingSession, setStreamingSession] =
    createSignal<StreamingSession | null>(null);
  ...
  return (
    <div
      class="min-h-screen bg-gradient-to-b from-blue-50 via-purple-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900
      ...
      <div class="relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center">
          ...
          <p class="text-xl text-gray-600 dark:text-gray-300 mb-12 max-w-3xl mx-auto">
            Tired of generic city guides? Loci creates hyper-personalized travel
            plans based on your unique interests and real-time context.
          </p>
