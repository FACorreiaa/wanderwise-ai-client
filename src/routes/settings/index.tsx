...
export default function SettingsPage() {
  ...
  onMount(() => {
    ...
    if (
      tabParam &&
      ["settings", "tags", "interests", "profiles"].includes(tabParam)
    ) {
            ...
            <div class="text-center sm:text-left">
              ...
              <div class="flex flex-col sm:flex-row gap-2 mt-2">
                ...
                >
                  <Show
                    when={isUploading()}
                    fallback={<Upload class="w-3 h-3 sm:w-4 sm:h-4" />}
                  >
    ...
    return (
      <TagsComponent
        ...
        onDeleteTag={async (tag) => {
          ...
          if (
            confirm(`Are you sure you want to delete the tag "${tag.name}"?`)
          ) {
    ...
    return (
      <InterestsComponent
        ...
        onDeleteInterest={async (interest) => {
          ...
          if (
            confirm(
              `Are you sure you want to delete the interest "${interest.name}"?`,
            )
          ) {
                  ...
                  {(tab) => {
                    ...
                    return (
                      <button
                        ...
                        class={`flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 whitespace-nowrap ${
                          activeTab() === tab.id
                ...
                <For each={tabs}>
                  {(tab) => {
                    ...
                    return (
                      <button
                        onClick={() => setActiveTab(tab.id)}
                        class={`w-full flex items-center gap-3 px-4 py-3 text-left rounded-lg transition-all duration-200 font-medium ${
                          activeTab() === tab.id
                            ? "bg-blue-600 text-white shadow-lg"
                            : "text-gray-700 hover:bg-gray-100"
                        }`}
