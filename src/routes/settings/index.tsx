          ...
          <div class="space-y-6">
            <div class="rounded-3xl bg-white/80 dark:bg-slate-800/80 backdrop-blur border border-gray-200 dark:border-slate-700 shadow-sm p-6 sm:p-8">
              <div class="flex items-center justify-between mb-3">
                ...
                <div class="px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 text-xs font-semibold border border-blue-100 dark:border-blue-800">
                  Smart Fill
                </div>
              </div>
              <div class="w-full h-2.5 rounded-full bg-gray-100 dark:bg-slate-700 overflow-hidden">
                <div
                  class="h-full rounded-full bg-gradient-to-r from-[#0c7df2] via-[#5fa3ff] to-[#0f4eea]"
                  style={{ width: "78%" }}
                />
              </div>
