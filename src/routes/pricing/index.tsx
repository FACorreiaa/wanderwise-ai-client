...
import { Check, Clock, Crown, Heart, MapPin, Star, Zap } from "lucide-solid";
  ...
  const features = [
    {
      ...
      items: [
        {
          feature: "Basic AI recommendations",
          free: true,
          explorer: true,
          pro: true,
        },
        {
          feature: "Advanced AI with learning",
          free: false,
          explorer: true,
          pro: true,
        },
      ...
      <div class="max-w-7xl mx-auto px-4 py-12">
        ...
        <header class="text-center mb-16">
          ...
          <p class="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed mb-8">
            Choose the perfect plan for your exploration needs. Start free and
            upgrade anytime as you discover more.
          </p>
        ...
        {/* Pricing Cards */}
        <section
          class="grid md:grid-cols-3 gap-8 mb-20"
            ...
            return (
              ...
              >
                ...
                <div class="p-8">
                  ...
                  {plan.name === "Explorer" && !plan.disabled ? (
                    <A href="/pricing/plan-selection">
                      <button
                        class="w-full py-3 px-6 rounded-lg font-semibold transition-colors mb-6 focus:outline-none bg-blue-600 hover:bg-blue-700 focus:bg-blue-700 text-white focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                  ...
                  <div class="space-y-3">
                    ...
                    {plan.limitations.length > 0 && (
                      <>
                        ...
                        <h4 class="font-semibold text-card-foreground text-sm">
                          Limitations:
                        </h4>
                        <ul class="space-y-2" role="list">
        ...
        <section
          class="bg-muted/50 rounded-2xl p-8 mb-20"
          aria-labelledby="feature-comparison"
        >
          <h2
            id="feature-comparison"
            class="text-3xl font-bold text-foreground text-center mb-8"
          >
            Feature Comparison
          </h2>
            ...
            >
              <thead>
                <tr class="border-b border-border">
                  <th
                    class="text-left py-4 pr-4 font-semibold text-foreground"
                    scope="col"
                  >
                    Features
                  </th>
        ...
        <section class="mb-20" aria-labelledby="faq">
          ...
          <div class="max-w-3xl mx-auto space-y-6" role="list">
            ...
            >
              ...
              <p class="text-muted-foreground">
                We don't offer a traditional free trial, but our Free plan gives
                you access to core features. Plus, all paid plans come with a
            ...
            >
              ...
              <p class="text-muted-foreground">
                Our AI analyzes your explicit preferences, saved locations, and
                interaction patterns to provide increasingly personalized
            ...
            >
              ...
              <p class="text-muted-foreground">
                Yes! Annual subscriptions receive a 20% discount. Contact our
                support team to set up annual billing.
              </p>
            </article>
          </div>
        </section>
        ...
        {/* Call to Action */}
        <section
          class="text-center bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-700 dark:to-purple-700 rounded-2xl p-12 text-white"
          aria-labelledby="final-cta"
        >
          <h2 id="final-cta" class="text-3xl font-bold mb-4">
            Ready to Start Exploring?
          </h2>
          <p class="text-lg mb-8 text-white/90 max-w-2xl mx-auto">
            Join thousands of users who've already discovered their perfect
            spots with Loci. Start free and upgrade when you're ready for more.
          </p>
