      ...
      <div class="max-w-6xl mx-auto px-4 py-12">
        ...
        <header class="text-center mb-16">
          <h1 class="text-4xl md:text-6xl font-bold text-foreground mb-6">
            Powerful{" "}
            <span class="text-blue-600 dark:text-blue-400">Features</span>
          </h1>
          <p class="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Discover what makes Loci the smartest way to explore cities. Our
            AI-powered platform offers everything you need for personalized
            urban discovery.
          </p>
        </header>
            ...
            {searchCapabilities.map((capability, index) => {
              ...
              return (
                ...
                >
                  <div class="flex items-center mb-4">
                    <div
                      class="bg-background p-3 rounded-lg mr-4 shadow-md"
                      aria-hidden="true"
                    >
                      <IconComponent class="w-6 h-6 text-blue-600 dark:text-blue-400" />
                    </div>
        ...
        {/* AI Capabilities */}
        <section
          class="bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-700 dark:to-purple-700 rounded-lg p-8 mb-20 text-white"
          aria-labelledby="ai-capabilities"
        >
          <div class="text-center mb-8">
            <h2 id="ai-capabilities" class="text-3xl font-bold mb-4">
              AI-Generated Itineraries
            </h2>
            <p class="text-lg text-white/90 max-w-3xl mx-auto">
              Let our advanced AI create personalized itineraries based on your
              interests, available time, and location. From quick lunch breaks
        ...
        <section
          class="bg-muted/30 rounded-lg p-8 mb-20"
        ...
        >
          <div class="text-center mb-8">
            ...
            <p class="text-lg text-muted-foreground max-w-4xl mx-auto">
              Our AI doesn't just answer your questions - it remembers your
              conversations and builds a personalized knowledge base that gets
          ...
          <div class="grid md:grid-cols-2 gap-8" role="list">
            ...
            >
              ...
              <p class="text-muted-foreground mb-4">
                Unlike traditional chatbots that forget your previous messages,
                Loci remembers your entire conversation history. Ask follow-up
                questions, reference earlier discussions, and build on previous
            ...
            >
              ...
              <p class="text-muted-foreground mb-4">
                When you ask a question, our AI doesn't just generate a generic
                response. It searches through your conversation history and
                preferences to provide personalized, contextually relevant
                recommendations.
              </p>
              <ul class="space-y-2" role="list">
                <li class="flex items-center text-sm text-muted-foreground">
                  <div
                    class="w-1.5 h-1.5 bg-emerald-500 rounded-full mr-2"
                    aria-hidden="true"
                  ></div>
          ...
          <div class="mt-8 text-center">
            <div class="bg-gradient-to-r from-purple-50 to-emerald-50 dark:from-purple-950/30 dark:to-emerald-950/30 rounded-lg p-6 border border-purple-200/50 dark:border-purple-800/50">
              ...
              <p class="text-sm text-muted-foreground">
                <strong>You:</strong> "Show me some good restaurants in
                downtown."
                <br />
                <strong>Later:</strong> "What about something similar but
                vegetarian?"
                <br />
                <strong>Loci:</strong> Remembers your downtown preference and
                suggests vegetarian restaurants in the same area, taking into
                account your conversation history to provide exactly what you're
                looking for.
              </p>
            </div>
          </div>
        ...
        >
          <h2
            id="coming-soon"
            class="text-2xl font-bold text-foreground text-center mb-6"
          >
            Coming Soon
          </h2>
          <div class="grid md:grid-cols-2 gap-6" role="list">
            <div class="flex items-center" role="listitem">
              ...
              <div>
                ...
                <p class="text-sm text-muted-foreground">
                  Voice-powered search and commands
                </p>
              </div>
            </div>
            <div class="flex items-center" role="listitem">
        ...
        <section class="text-center" aria-labelledby="cta-heading">
          ...
          <p class="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Start exploring with our free tier or upgrade to Premium for
