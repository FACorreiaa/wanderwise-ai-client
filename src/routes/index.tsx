...
export default function Index(): JSX.Element {
  ...
  return (
    <>
      ...
      <Meta name="description" content="Discover your perfect travel experiences with Loci's AI-powered recommendations. Get personalized itineraries, restaurant suggestions, and activities tailored to your preferences." />
      <Meta name="keywords" content="AI travel planner, personalized travel, trip planning, travel recommendations, itinerary planner, restaurant finder, travel discovery, AI travel assistant" />
      <Meta property="og:title" content="Loci - AI-Powered Travel Discovery" />
      <Meta property="og:description" content="Discover your perfect travel experiences with AI-powered, personalized recommendations for itineraries, restaurants, and activities." />
      <Meta property="og:url" content="https://loci.app" />
      <Meta name="twitter:title" content="Loci - AI-Powered Travel Discovery" />
      <Meta name="twitter:description" content="Discover your perfect travel experiences with AI-powered, personalized recommendations." />
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "description": "AI-powered travel discovery platform delivering hyper-personalized city exploration recommendations",
          "sameAs": [
            "https://twitter.com/loci"
          ]
        })}
      </script>
