...
import { Compass, Home, MapPin, Search } from "lucide-solid";
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center px-4 py-8">
      <div class="text-center max-w-md mx-auto">
        ...
        <p class="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
          Looks like this location doesn't exist on our travel map. Let's get
          you back on track to discover amazing places!
        </p>
        ...
        <div class="mt-8 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
          ...
          <p class="text-xs text-blue-800 dark:text-blue-200">
            Lost pages are like hidden destinations - sometimes the best
            adventures happen when you're off the beaten path!
          </p>
        </div>
      </div>
    </div>
