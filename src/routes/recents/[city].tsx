...
export default function CityDetailsPage() {
  ...
  const cityDetailsQuery = useCityDetails(
  ...
  const renderPlaceCard = (
    place: POIDetailedInfo | HotelDetailedInfo | RestaurantDetailedInfo,
    type: "poi" | "hotel" | "restaurant",
  ) => (
      ...
      <div class="flex gap-3">
        ...
        <div class="flex-1 min-w-0">
          <div class="flex items-start justify-between mb-2">
            <div class="flex-1 min-w-0">
              <h3 class="font-semibold text-gray-900 dark:text-white text-base mb-1">
                {place.name}
              </h3>
        ...
        <div class="flex-1 min-w-0">
          ...
          <div class="space-y-3">
            ...
            <div class="flex items-center gap-4 pt-2 border-t border-gray-100 dark:border-gray-700">
              ...
              <Show
                when={
                  interaction.restaurants && interaction.restaurants.length > 0
                }
              >
                <div class="flex items-center gap-1 text-xs text-gray-600 dark:text-gray-400">
            ...
            <div class="flex-1 min-w-0">
              ...
              <Show when={cityDetailsQuery.data}>
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                  ...
                  {(cityDetailsQuery.data?.interactions?.length || 0) !== 1
                    ? "s"
                    : ""}{" "}
            ...
            <div class="space-y-6">
              ...
              <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div class="space-y-4">
                  <For
                    each={
                      cityDetailsQuery.data?.interactions?.slice(0, 3) || []
                    }
                  >
                    {(interaction) => (
                      <div class="flex items-start gap-3">
                  ...
                  <Show
                    when={
                      (cityDetailsQuery.data?.interactions?.length || 0) > 3
                    }
                  >
                    <button
                      onClick={() => setActiveTab("interactions")}
                ...
                <div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <For each={allPlaces().restaurants}>
                      {(restaurant) =>
                        renderPlaceCard(restaurant, "restaurant")
                      }
                    </For>
                  </div>
                </div>
              ...
              >
                <div class="text-center py-12">
                  ...
                  <p class="text-gray-600 dark:text-gray-400">
                    No places were discovered in your interactions for this
                    city.
                  </p>
                </div>
              </Show>
                    ...
                    <For each={cityDetailsQuery.data?.saved_itineraries || []}>
                      {(itinerary) => (
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-all duration-200">
                            ...
                            <div class="flex-1 min-w-0">
                              ...
                              <div class="flex flex-wrap items-center gap-3 text-sm text-gray-500 dark:text-gray-500">
                                <div class="flex items-center gap-1">
                                  ...
                                  <span>
                                    Saved {formatDate(itinerary.created_at)}
                                  </span>
                                </div>
                                <Show when={itinerary.estimated_duration_days}>
                                  <div class="flex items-center gap-1">
                                    <Clock class="w-4 h-4" />
                                    <span>
                                      {itinerary.estimated_duration_days} days
                                    </span>
                                  </div>
                                </Show>
                          ...
                          <Show
                            when={itinerary.tags && itinerary.tags.length > 0}
                          >
